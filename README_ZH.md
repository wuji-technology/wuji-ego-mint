...
<table>
<tr>
  <td><a href="#-发布状态">📋 发布状态</a></td>
  <td><a href="#-快速开始web-viewer">🚀 快速开始：Web Viewer</a></td>
  <td><a href="#-mint-是怎么工作的">🧠 MINT 是怎么工作的</a></td>
</tr>
<tr>
  <td><a href="#-评测口径">📊 评测口径</a></td>
  <td><a href="#-功能范围">📦 功能范围</a></td>
  <td><a href="#️-模型训练与可选管线复现">🏋️ 模型训练与可选管线复现</a></td>
</tr>
<tr>
  <td><a href="#️-公开-ego-预训练数据">🗂️ 公开 Ego 预训练数据</a></td>
  <td><a href="#-lerobot-样例与隐私">🔐 LeRobot 样例与隐私</a></td>
  <td><a href="#️-已知局限">⚠️ 已知局限</a></td>
</tr>
<tr>
  <td><a href="#-仓库结构">🧾 仓库结构</a></td>
  <td><a href="#-文档">📚 文档</a></td>
  <td><a href="#-致谢">✨ 致谢</a></td>
</tr>
<tr>
  <td><a href="#-许可证">📜 许可证</a></td>
  <td><a href="#-引用">📖 引用</a></td>
  <td></td>
</tr>
</table>
