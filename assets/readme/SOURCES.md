...
| `figure_egopipeline.webp` | `egopipeline.drawioV3(2).pdf` (diagrams.net), rasterised at 3409 px and downscaled to 1700 px wide | EgoPipeline's stages and post-processing. Sits above *Where the supervision comes from* |
